---
title: Bitcoin Pi trading strategy
date: "2020-03-01"
image: https://blue-images.talaikis.com/pi-returns.png
description: BlueBlood quantitative Bitcoin Pi trading strategy signals.
---
...
* [More Bitcoin Pi stats](/performance)
...
* Strategy endpoint: /v1.0/signals/pi
* Statistics: /v1.0/stats/pi
* Yearly returns: /v1.0/returns-yearly/pi
* Monthly returns: /v1.0/returns-monthly/pi
* Weekly returns: /v1.0/returns-weekly/pi
* MAE: /v1.0/mae/pi
* MFE: /v1.0/mfe/pi
