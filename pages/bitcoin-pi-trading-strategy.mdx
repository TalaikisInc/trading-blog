...
export const meta = {
  ...
  summary: 'BlueBlood quantitative Bitcoin Pi trading strategy signals.'
}

export async function getStaticProps() {
  const res = await fetch('https://api.talaikis.com/v1.0/stats/pi')
...
Bitcoin One is quantitative trading strategy in Bitcoin, which uses [quantitative trading models](https://blueblood.talaikis.com/posts/trading-philosophy) for trading decisions making.
...
* [More Bitcoin Pi stats](https://blueblood.talaikis.com/performance)
