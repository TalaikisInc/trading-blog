...
Similarly, MFE is maximum favorable excurons, the positive difference between price of the signal and highest high.
...
Let's say, strategy generates a buy signal at 9100 USD. You can buy at that price and expect results shown in the retuns plot, or you can just set buy limit at 9100 minus 200 (80% of MAEs) at 8900 and set take profit at recommended price + 200 USD (majority of MFEs).
...
MAE will usually be higher in bad times and MFE will be higher in good times, so we recommned to use appropriate position management strategy to catch more of the MAE and MFE.
