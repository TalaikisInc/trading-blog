...
```pythonrectangle[5] = [1, 2, 1, 2, 0]
cup = [6, 3, 2, 1, 1, 1, 2, 3, 6, 0]
zigzag = [1, 7, 2, 8, 0]
headShldrs = [1, 2, 3, 3, 3, 4, 5, 6, 6, 5, 4, 3, 3, 3, 2, 1, 0]
cup = [6, 3, 2, 1, 1, 1, 2, 3, 6, 0]
