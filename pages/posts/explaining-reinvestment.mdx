...
export const meta = {
  ...
  summary: 'Explaining reinvestment strategy.'
}
...
I am generating [performance of the strategies](https://blueblood.talaikis.com/performance) as not reinvested and I'm doing it in order to be able to compare strategies returns instead of time value returns.
