...
Note that reinvestment returns are misleading, because they largely depend on [when you have started](https://blueblood.talaikis.com/posts/explaining-reinvestment).
