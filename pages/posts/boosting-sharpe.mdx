...
export const meta = {
  ...
  summary: 'Simple sizing strategy boosting Sharpe ratio from 3.28 to 3.5.'
}
...
![](https://blue-images.talaikis.com/position-dd2.png)
...
![](https://blue-images.talaikis.com/position-mr.png)
...
![](https://blue-images.talaikis.com/position1.png)
...
![](https://blue-images.talaikis.com/position-dd3.png)

So, we now can run with reinvestment:

![](https://blue-images.talaikis.com/position2.png)

Max drawdown of modified strategy is now 40% instead of 175%, aprox. 77% less and returns over the entire period are aprox. 56% lower.

![](https://blue-images.talaikis.com/position-dd1.png)

So, I hope this experiment shows a good deal on why it is so hard to reduce risk and not to reduce profit with it.

Note that reinvestment returns are misleading, because they largely depend on [when you have started](https://blueblood.talaikis.com/explaining-reinvestment).
