...
export const meta = {
  ...
  summary: 'BlueBlood quantitative Bitcoin S 2.0 trading strategy signals.'
}

export async function getStaticProps() {
  const res = await fetch('https://api.talaikis.com/v1.0/stats/s-2')
...
Bitcoin S 2.0 is quantitative trading strategy in Bitcoin, which uses [quantitative trading models](https://blueblood.talaikis.com/posts/trading-philosophy) for trading decisions making.
...
* [More Bitcoin S 2.0 stats](https://blueblood.talaikis.com/performance)
