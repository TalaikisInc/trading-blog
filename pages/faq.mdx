...
MAE is maximum adverse excursion, MFE is maximum favorable excursion. To help you, I provide those on our API and on [this page](/posts/introducing-bitcoin-strategies).

Also, read my post on [MAEs and MFEs](/posts/explaining-mae-mfe-trading).
