...
export const meta = {
  ...
  summary: 'BlueBlood quantitative Bitcoin One trading strategy signals.'
}

export async function getStaticProps() {
  const res = await fetch('https://api.talaikis.com/v1.0/stats/one')
...
* [More Bitcoin One stats](https://blueblood.talaikis.com/performance)
