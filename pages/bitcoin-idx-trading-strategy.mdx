...
export const meta = {
  ...
  summary: 'BlueBlood quantitative Bitcoin trading strategies portfolio signals.'
}

export async function getStaticProps() {
  const res = await fetch('https://api.talaikis.com/v1.0/stats/index')
...
Bitcoin strategies portfolio is quantitative trading strategy in Bitcoin, which uses [quantitative trading models](https://blueblood.talaikis.com/posts/trading-philosophy) for trading decisions making.
...
* [More Bitcoin portfolio stats](https://blueblood.talaikis.com/performance)
