...
export const meta = {
  ...
  summary: 'BlueBlood quantitative Bitcoin One 2.0 trading strategy signals.'
}

export async function getStaticProps() {
  const res = await fetch('https://api.talaikis.com/v1.0/stats/one-2')
...
Bitcoin One 2.0 is quantitative trading strategy in Bitcoin, which uses [quantitative trading models](https://blueblood.talaikis.com/posts/trading-philosophy) for trading decisions making.

Trading decision making model (alpha) of this strategy is based on proprietary algorithmic indicators, which uses Bitcoin returns structures.

![Bitcoin One 2.0 Returns](https://blue-images.talaikis.com/one-2-returns.png "Bitcoin One 2.0 Returns")

* [More Bitcoin One 2.0 stats](https://blueblood.talaikis.com/performance)
